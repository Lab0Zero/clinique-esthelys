...
export default function FeatureCarousel() {
  ...
  return (
    <section className="py-20 sm:py-28 md:py-36 border-t border-border-light">
      <div className="container-site">
        <ScrollReveal>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            {/* Right — image with clip-path transition */}
            <div className="relative overflow-hidden">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    <Image src={slide.image} alt={slide.title} fill className="object-cover grayscale" sizes="(max-width: 1024px) 100vw, 50vw" quality={85} />
                  </motion.div>
                </motion.div>
              </AnimatePresence>
            </div>
